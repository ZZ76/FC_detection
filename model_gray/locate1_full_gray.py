...
def slide(ws, ss):   # ws = window_size, ss = step_size
    ...
    while flag_y is True:
        ...
        while flag_x is True:
            ...
            x1 = x1 + ss
            x2 = x2 + ss
            if x2 <= ws:   # on left edge
                x1 = 0
            if x2 > width:   # on the rigt edge
                x2 = width
...
def countcontours():   # find center of each contour put into center_list[], then pick images use center
    cv2.line(centers_map, (1, 1), (width, 1), (255, 255, 255), 2)   # top
    cv2.line(centers_map, (width, 1), (width, height), (255, 255, 255), 2)   # right
    cv2.line(centers_map, (1, height), (width, height), (255, 255, 255), 2)   # bottom
    cv2.line(centers_map, (1, 1), (1, height), (255, 255, 255), 2)   # left
...
#image_name = '../single_testing_images/DFC2/DFC_AOI_RGB_tile50.TIF'
...
img_folder_path = '../single_testing_images/DFC3'
